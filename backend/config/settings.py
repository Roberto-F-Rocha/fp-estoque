...
INSTALLED_APPS=['django.contrib.admin','django.contrib.auth','django.contrib.contenttypes','django.contrib.sessions','django.contrib.messages','django.contrib.staticfiles','corsheaders','rest_framework','django_filters','drf_spectacular','inventory']
...
LANGUAGE_CODE='pt-br'; TIME_ZONE='America/Fortaleza'; USE_I18N=True; USE_TZ=True
...
SPECTACULAR_SETTINGS={'TITLE':'FP Estoque API','VERSION':'1.0.0'}
